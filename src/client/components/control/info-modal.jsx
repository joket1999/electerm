        ...
        content: (
            <div className="about-wrap">
                <Tabs defaultActiveKey="1">
                    ...
                    <TabPane tab={e('thanks')} key="3">
                        {
                            licenses.map((v, i) => {
                                return (
                                    <div className="pd1b" key={i + '_thks_'}>
                                        <p style={{marginBottom: 0}}>
                                            <b className="bold">{v.author}</b>
                                        </p>
                                        <p>
                                            <Link to={v.git}>
                                                {v.git}
                                        ...
                                        <pre style={{ wordWrap: 'break-word', whiteSpace: 'pre-wrap' }} dangerouslySetInnerHTML={{ __html: v.license }}>
                                        </pre>
                                    </div>
                                )
                            })
